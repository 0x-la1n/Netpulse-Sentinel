...
export const Configuration = ({ settings, onSave }) => {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6 pb-8">
      <section className="rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-6 md:p-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-100 md:text-3xl">Configuración avanzada de monitoreo</h2>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-950/70 px-4 py-3 text-xs text-slate-400">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
          <div className="mb-5 flex items-center gap-2 text-slate-100">
            ...
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Motor de monitoreo</h3>
          </div>
        ...
        <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
          <div className="mb-5 flex items-center gap-2 text-slate-100">
            ...
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Resiliencia y alertas</h3>
          </div>
        ...
        <section className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
          <div className="mb-5 flex items-center gap-2 text-slate-100">
            ...
            <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Dashboard e historial</h3>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <label className="block rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-900 p-2 text-slate-100"
              />
              <span className="mt-2 block text-xs text-slate-500">Cantidad de puntos de sparkline para cada tarjeta.</span>
            </label>
        ...
        <div className="sticky bottom-4 z-10 rounded-2xl border border-slate-800 bg-slate-900/95 p-4 backdrop-blur">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-emerald-400 disabled:opacity-70"
              >
